...
public class RegionSelect extends View{
    ...
    public RegionSelect(Context context, List<Point> points, Bitmap mImage) {
        ...
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(context.getResources().getIdentifier("polygonViewCircleBackground", "color", getPackageName())));

        nPaint = new Paint();
        nPaint.setColor(getResources().getColor(context.getResources().getIdentifier("blue", "color", getPackageName())));
